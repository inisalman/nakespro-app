      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-xl border border-neutral-200 p-5">
            <div className="text-body-small text-neutral-500 mb-1">Total Website</div>
            <div className="text-title">{orders.length}</div>
          </div>
          <div className="bg-white rounded-xl border border-neutral-200 p-5">
            <div className="text-body-small text-neutral-500 mb-1">Live</div>
            <div className="text-title text-green-600">
              {orders.filter((o) => o.buildStatus === "done").length}
            </div>
          </div>
          <div className="bg-white rounded-xl border border-neutral-200 p-5">
            <div className="text-body-small text-neutral-500 mb-1">Dalam Progress</div>
            <div className="text-title text-purple-600">
              {orders.filter((o) => ["payment_confirmed", "designing", "review"].includes(o.buildStatus)).length}
            </div>
          </div>
          <div className="bg-white rounded-xl border border-neutral-200 p-5">
            <div className="text-body-small text-neutral-500 mb-1">Perlu Aksi</div>
            <div className="text-title text-orange-600">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium border ${getStatusColor(order.buildStatus)}`}>
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-neutral-600">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            <span>{order.billingCycle === "monthly" ? "Bulanan" : "Tahunan"}</span>
                          </div>
                          ...
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium border ${getPaymentStatusColor(order.paymentStatus)}`}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {order.buildStatus === "done" && order.websiteUrl && (
                          <a
                            ...
                            className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all hover:-translate-y-0.5"
                          >
